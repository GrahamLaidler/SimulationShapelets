...
m1_traindists_s₁_true = [dist_shapelet_series(Model1_s₁[1], trueseries_train[i], LocInv=Yes()) for i in 1:length(trueseries_train)];
m1_traindists_s₁_model = [dist_shapelet_series(Model1_s₁[1], model1series_train[i], LocInv=Yes()) for i in 1:length(model1series_train)];
m1_traindists_s₂_true = [dist_shapelet_series(Model1_s₂[1], trueseries_train[i], LocInv=Yes()) for i in 1:length(trueseries_train)];
m1_traindists_s₂_model = [dist_shapelet_series(Model1_s₂[1], model1series_train[i], LocInv=Yes()) for i in 1:length(model1series_train)];
m1_testdists_s₁_true = [dist_shapelet_series(Model1_s₁[1], trueseries_test[i], LocInv=Yes()) for i in 1:length(trueseries_test)];
m1_testdists_s₁_model = [dist_shapelet_series(Model1_s₁[1], model1series_test[i], LocInv=Yes()) for i in 1:length(model1series_test)];
m1_testdists_s₂_true = [dist_shapelet_series(Model1_s₂[1], trueseries_test[i], LocInv=Yes()) for i in 1:length(trueseries_test)];
m1_testdists_s₂_model = [dist_shapelet_series(Model1_s₂[1], model1series_test[i], LocInv=Yes()) for i in 1:length(model1series_test)];
...
m2_traindists_s₁_true = [dist_shapelet_series(Model2_s₁[1], trueseries_train[i], LocInv=Yes()) for i in 1:length(trueseries_train)];
m2_traindists_s₁_model = [dist_shapelet_series(Model2_s₁[1], model2series_train[i], LocInv=Yes()) for i in 1:length(model2series_train)];
m2_traindists_s₂_true = [dist_shapelet_series(Model2_s₂[1], trueseries_train[i], LocInv=Yes()) for i in 1:length(trueseries_train)];
m2_traindists_s₂_model = [dist_shapelet_series(Model2_s₂[1], model2series_train[i], LocInv=Yes()) for i in 1:length(model2series_train)];
m2_testdists_s₁_true = [dist_shapelet_series(Model2_s₁[1], trueseries_test[i], LocInv=Yes()) for i in 1:length(trueseries_test)];
m2_testdists_s₁_model = [dist_shapelet_series(Model2_s₁[1], model2series_test[i], LocInv=Yes()) for i in 1:length(model2series_test)];
m2_testdists_s₂_true = [dist_shapelet_series(Model2_s₂[1], trueseries_test[i], LocInv=Yes()) for i in 1:length(trueseries_test)];
m2_testdists_s₂_model = [dist_shapelet_series(Model2_s₂[1], model2series_test[i], LocInv=Yes()) for i in 1:length(model2series_test)];
