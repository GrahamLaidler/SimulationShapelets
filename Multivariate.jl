...
testdistsA_s₁_system1 = [dist_shapelet_series(IndepA_s₁[1], system1series_test[1][i], LocInv=Yes()) for i in 1:length(system1series_test[1])];
testdistsA_s₁_system2 = [dist_shapelet_series(IndepA_s₁[1], system2series_test[1][i], LocInv=Yes()) for i in 1:length(system2series_test[1])];
testdistsA_s₂_system1 = [dist_shapelet_series(IndepA_s₂[1], system1series_test[1][i], LocInv=Yes()) for i in 1:length(system1series_test[1])];
testdistsA_s₂_system2 = [dist_shapelet_series(IndepA_s₂[1], system2series_test[1][i], LocInv=Yes()) for i in 1:length(system2series_test[1])];
testdistsB_s₁_system1 = [dist_shapelet_series(IndepB_s₁[1], system1series_test[2][i], LocInv=Yes()) for i in 1:length(system1series_test[2])];
testdistsB_s₁_system2 = [dist_shapelet_series(IndepB_s₁[1], system2series_test[2][i], LocInv=Yes()) for i in 1:length(system2series_test[2])];
testdistsB_s₂_system1 = [dist_shapelet_series(IndepB_s₂[1], system1series_test[2][i], LocInv=Yes()) for i in 1:length(system1series_test[2])];
testdistsB_s₂_system2 = [dist_shapelet_series(IndepB_s₂[1], system2series_test[2][i], LocInv=Yes()) for i in 1:length(system2series_test[2])];
testdistsC_s₁_system1 = [dist_shapelet_series(IndepC_s₁[1], system1series_test[3][i], LocInv=Yes()) for i in 1:length(system1series_test[3])];
testdistsC_s₁_system2 = [dist_shapelet_series(IndepC_s₁[1], system2series_test[3][i], LocInv=Yes()) for i in 1:length(system2series_test[3])];
testdistsC_s₂_system1 = [dist_shapelet_series(IndepC_s₂[1], system1series_test[3][i], LocInv=Yes()) for i in 1:length(system1series_test[3])];
testdistsC_s₂_system2 = [dist_shapelet_series(IndepC_s₂[1], system2series_test[3][i], LocInv=Yes()) for i in 1:length(system2series_test[3])];
...
testdistsmulti_s₁_system2 = [multidep_dist_shapelet_series(Multi_s₁[1], [system2series_test[d][i] for d in 1:length(system2series_test)], LocInv=Yes())[1] for i in 1:length(system2series_test[1])]
testdistsmulti_s₂_system1 = [multidep_dist_shapelet_series(Multi_s₂[1], [system1series_test[d][i] for d in 1:length(system1series_test)], LocInv=Yes())[1] for i in 1:length(system1series_test[1])]
testdistsmulti_s₂_system2 = [multidep_dist_shapelet_series(Multi_s₂[1], [system2series_test[d][i] for d in 1:length(system2series_test)], LocInv=Yes())[1] for i in 1:length(system2series_test[1])]
