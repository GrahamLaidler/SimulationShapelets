...
function Figure1()
    ...
    noinsystem_plot = plot(series[:,1], series[:,2], linetype=:steppost, lw=2, color=:plum4, xlabel=L"t", ylabel="number-in-system", legend=:none, tickfontsize=5, xguidefontsize=10, yguidefontsize=8, dpi=600, margin=3mm)
    throughput_plot = plot(series[:,1], series[:,3], linetype=:steppost, lw=2, color=:plum4, xlabel=L"t", ylabel="throughput", legend=:none, tickfontsize=5, xguidefontsize=10, yguidefontsize=8, dpi=600, margin=3mm)
    waittime_plot = plot(series[3:end,1], series[3:end,4], linetype=:steppost, lw=2, color=:plum4, xlabel=L"t", ylabel="latest sojourn time", legend=:none, tickfontsize=5, xguidefontsize=10, yguidefontsize=8, dpi=600)
...
function Figure4()
    ...
    WFshapelets = plot(LRWcontrolled_s₁[1][:,1], LRWcontrolled_s₁[1][:,2] .- minimum(LRWcontrolled_s₁[1][:,2]), linetype=:steppost, lw=2, color=:sienna1, xlabel=L"t", ylabel=L"s(t) - \min_u s(u)", label=L"s_1", tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=8, legend=:topleft, dpi=600)
    ...
    WFscatter_train = scatter(traindists_s₁_LRW, traindists_s₂_LRW, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="LRW", xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", xlim=(-4,130),ylim=(-4,130), yticks=0:40:120, xticks=0:40:120, legend=:topright, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, titlefontsize=8, dpi=600) #xlim=(0,15000), ylim=(0,8200), xticks=(0:5000:15000, 0:7), yticks=(0:1000:6000, 0:6)
    WFscatter_train = annotate!(65, 135, text("training", :black, 8))
    WFscatter_train = scatter!(traindists_s₁_MRW, traindists_s₂_MRW, color=:plum4, alpha=0.5, ms=2, markerstrokewidth=0.1, label="MRW")
    WFscatter_test = scatter(testdists_s₁_LRW, testdists_s₂_LRW, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="LRW", xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", xlim=(-4,130),ylim=(-4,130), yticks=0:40:120, xticks=0:40:120, legend=:topright, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, titlefontsize=8, dpi=600)
    WFscatter_test = annotate!(65, 135, text("testing", :black, 8))
...
function Figure5()
    ...
    WFshapelets = plot(LRWrandom_s₁[1][:,1], LRWrandom_s₁[1][:,2] .- minimum(LRWrandom_s₁[1][:,2]), linetype=:steppost, lw=2, color=:sienna1, xlabel=L"t", ylabel=L"s(t) - \min_u s(u)", label=L"s_1", xticks=0:10:80, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=8, legend=:topleft, dpi=600)
    WFshapelets = plot!(MRWrandom_s₂[1][:,1], MRWrandom_s₂[1][:,2] .- minimum(MRWrandom_s₂[1][:,2]), linetype=:steppost, lw=2, color=:plum4, label=L"s_2")
    WFscatter_train = scatter(r_traindists_s₁_LRW, r_traindists_s₂_LRW, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="LRW", xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", xlim=(-8,400), ylim=(-20, 840), legend=:topleft, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, titlefontsize=8, dpi=600)
    WFscatter_train = annotate!(200, 850, text("training", :black, 8))
    ...
    WFscatter_test =scatter(r_testdists_s₁_LRW, r_testdists_s₂_LRW, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="LRW", xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", xlim=(-8,400), ylim=(-20, 840), legend=:topleft, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, titlefontsize=8, dpi=600)
    WFscatter_test =annotate!(200, 850, text("testing", :black, 8))
...
function Figure6()
    ...
    arrivalrates = plot!([10-(10/(2*pi))*asin(0.5), 10],[0.5,0.5], color=:sienna1, linestyle=:dash, linewidth=2,label="model 2")
    ...
    Queuediagram = annotate!(2, 11, text("Station A", :black, 8))
    Queuediagram = annotate!(2, 7, text("Station B", :black, 8))
    Queuediagram = annotate!(2, 3, text("Station C", :black, 8))
    ...
    Queuediagram = annotate!(2.75, 1, text("exit", :black, 8))
...
function Figure7()
    ...
    m1_scatter_train = scatter(m1_traindists_s₁_true, m1_traindists_s₂_true, color=:mediumseagreen, alpha=0.5, ms=2, markerstrokewidth=0.1, label="true", xlim=(-0.1,5.8), ylim=(-0.35,10), yticks=0:2:10, xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", legend=:bottomleft, xguidefontsize=8, yguidefontsize=8, legendfontsize=4, xtickfontsize=5, ytickfontsize=5, titlefontsize=8, dpi=600)
    m1_scatter_train = annotate!(2.85, 10.5, text("training", :black, 8))
    m1_scatter_train = scatter!(m1_traindists_s₁_model, m1_traindists_s₂_model, color=:plum4, alpha=0.5, ms=2, markerstrokewidth=0.1, label="model 1")
    m1_scatter_test = scatter(m1_testdists_s₁_true, m1_testdists_s₂_true, color=:mediumseagreen, alpha=0.5, ms=2, markerstrokewidth=0.1, label="true", xlim=(0.75,7.8), ylim=(1.5,10), xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", legend=:bottomright, xguidefontsize=8, yguidefontsize=8, legendfontsize=4, xtickfontsize=5, ytickfontsize=5, titlefontsize=8, dpi=600)
    m1_scatter_test = annotate!(4.275, 10.5, text("testing", :black, 8))
    m1_scatter_test = scatter!(m1_testdists_s₁_model, m1_testdists_s₂_model, color=:plum4, alpha=0.5, ms=2, markerstrokewidth=0.1, label="model 1")
    ...
    contour(X, Y, ftrue1, linewidth=2, levels=10, color=cgrad([:white, :mediumseagreen], [0.3, 0.7]), cbar=false, xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", yticks=4:2:8, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, xtickfontsize=5, ytickfontsize=5, dpi=600)
    contour!(X, Y, fmodel1, linewidth=2, levels=10, color=cgrad([:white, :plum4], [0.3, 0.7]))
    Model1contours = plot!([3,3.01],[6.95,6.96], linewidth=0.5, color=:mediumseagreen, label="true", legendfontsize=4)
    Model1contours = plot!([3.95,3.95],[5.75,5.76], linewidth=0.5, color=:plum4, label="model 1", legendfontsize=4)
...
function Figure8()
    ...
    m2_scatter_train = scatter(m2_traindists_s₁_true, m2_traindists_s₂_true, color=:mediumseagreen, alpha=0.5, ms=2, markerstrokewidth=0.1, label="true", xlim=(-0.2,12.5), ylim=(-0.3,9), xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", xguidefontsize=8, yguidefontsize=8, legendfontsize=4, xtickfontsize=5, ytickfontsize=5, titlefontsize=8, legend=:bottomleft, dpi=600)
    m2_scatter_train = annotate!(6.15, 9.5, text("training", :black, 8))
    m2_scatter_train = scatter!(m2_traindists_s₁_model, m2_traindists_s₂_model, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="model 2")
    m2_scatter_test = scatter(m2_testdists_s₁_true, m2_testdists_s₂_true, color=:mediumseagreen, alpha=0.5, ms=2, markerstrokewidth=0.1, label="true", xlim=(2.6,15.1), ylim=(1.2,10), xticks=4:2:14, xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", xguidefontsize=8, yguidefontsize=8, legendfontsize=4, xtickfontsize=5, ytickfontsize=5, titlefontsize=8, legend=:bottomright, dpi=600)
    m2_scatter_test = annotate!(8.85, 10.5, text("testing", :black, 8))
    m2_scatter_test = scatter!(m2_testdists_s₁_model, m2_testdists_s₂_model, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="model 2")
    ...
    contour(X, Y, ftrue2, linewidth=2, levels=10, color=cgrad([:white, :mediumseagreen], [0.3, 0.7]), cbar=false, xlabel=L"\tilde{dist}(s_1, y)", ylabel=L"\tilde{dist}(s_2, y)", xticks=6:2:10, yticks=4:2:8, xguidefontsize=8, yguidefontsize=8, xtickfontsize=5, ytickfontsize=5, legendfontsize=6, dpi=600)
    contour!(X, Y, fmodel2, linewidth=2, levels=10, color=cgrad([:white, :sienna1], [0.3, 0.7]))
    Model2contours = plot!([7,7],[5.2,5.2], linewidth=0.5, color=:mediumseagreen, label="true", legendfontsize=4)
    Model2contours = plot!([7,7],[5.55,5.55], linewidth=0.5,color=:sienna1, label="model 2", legendfontsize=4)
...
function Figure9()
    ...
    IndepB_testscatter = scatter(testdistsB_s₁_system1, testdistsB_s₂_system1, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="system 1", xlabel=L"\tilde{dist}(s_{B1}, y_B)", ylabel=L"\tilde{dist}(s_{B2}, y_B)", legend=:topright, tickfontsize=5, xguidefontsize=8, yguidefontsize=8, legendfontsize=4, titlefontsize=8, size=(600,500), dpi=600)
    IndepB_testscatter = scatter!(testdistsB_s₁_system2, testdistsB_s₂_system2, color=:plum4, alpha=0.5, ms=2, markerstrokewidth=0.1, label="system 2")

    IndepC_shapelets = plot(IndepC_s₁[1][:,1], IndepC_s₁[1][:,2].-minimum(IndepC_s₁[1][:,2]), linetype=:steppost, lw=2, color=:sienna1, xlabel=L"t", ylabel=L"s(t) - \min_u s(u)", label=L"s_{C1}", ylim=(-0.3,6.3), xlim=(-0.3, 12), yticks=0:2:6, xticks=0:2:12, tickfontsize=5, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, legend=:right, size=(600,500), dpi=600)
    IndepC_shapelets = plot!(IndepC_s₂[1][:,1], IndepC_s₂[1][:,2].-minimum(IndepC_s₂[1][:,2]), linetype=:steppost, lw=2, color=:plum4, label=L"s_{C2}")
    IndepC_testscatter = scatter(testdistsC_s₁_system1, testdistsC_s₂_system1, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="system 1", xlabel=L"\tilde{dist}(s_{C1}, y_C)", ylabel=L"\tilde{dist}(s_{C2}, y_C)", legend=:topright, tickfontsize=5, xguidefontsize=8, yguidefontsize=8, legendfontsize=4, titlefontsize=8, size=(600,500), dpi=600)
    IndepC_testscatter = scatter!(testdistsC_s₁_system2, testdistsC_s₂_system2, color=:plum4, alpha=0.5, ms=2, markerstrokewidth=0.1, label="system 2")
...
function Figure11()
    ...
    proofdiagram = annotate!(10.0, -0.4, text("time", :black, 10))
