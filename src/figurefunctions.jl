...
function Figure4()
    ...
    WFscatter_train = annotate!(65, 135, text(L"\textrm{training}", :black, 8))
    ...
    WFscatter_test = annotate!(65, 135, text(L"\textrm{testing}", :black, 8))
...
function Figure5()
    ...
    WFscatter_train = annotate!(200, 850, text(L"\textrm{training}", :black, 8))
    ...
    WFscatter_test =annotate!(200, 850, text(L"\textrm{testing}", :black, 8))
...
function Figure7()
    ...
    m1_scatter_train = annotate!(2.85, 10.5, text(L"\textrm{training}", :black, 8))
    ...
    m1_scatter_test = annotate!(4.275, 10.5, text(L"\textrm{testing}", :black, 8))
...
function Figure8()
    ...
    m2_scatter_train = annotate!(6.15, 9.5, text(L"\textrm{training}", :black, 8))
    ...
    m2_scatter_test = annotate!(8.85, 10.5, text(L"\textrm{testing}", :black, 8))
