...
function Figure4()
    ...
    WFscatter_train = scatter(traindists_s₁_LRW, traindists_s₂_LRW, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="LRW", xlabel=L"\tilde{\mathrm{dist}}(s_1, y)", ylabel=L"\tilde{\mathrm{dist}}(s_2, y)", xlim=(-4,130),ylim=(-4,130), yticks=0:40:120, xticks=0:40:120, legend=:topright, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, titlefontsize=8, dpi=600) #xlim=(0,15000), ylim=(0,8200), xticks=(0:5000:15000, 0:7), yticks=(0:1000:6000, 0:6)
    ...
    WFscatter_test = scatter(testdists_s₁_LRW, testdists_s₂_LRW, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="LRW", xlabel=L"\tilde{\mathrm{dist}}(s_1, y)", ylabel=L"\tilde{\mathrm{dist}}(s_2, y)", xlim=(-4,130),ylim=(-4,130), yticks=0:40:120, xticks=0:40:120, legend=:topright, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, titlefontsize=8, dpi=600)
...
function Figure5()
    ...
    WFscatter_train = scatter(r_traindists_s₁_LRW, r_traindists_s₂_LRW, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="LRW", xlabel=L"\tilde{\mathrm{dist}}(s_1, y)", ylabel=L"\tilde{\mathrm{dist}}(s_2, y)", xlim=(-8,400), ylim=(-20, 840), legend=:topleft, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, titlefontsize=8, dpi=600)
    ...
    WFscatter_test =scatter(r_testdists_s₁_LRW, r_testdists_s₂_LRW, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="LRW", xlabel=L"\tilde{\mathrm{dist}}(s_1, y)", ylabel=L"\tilde{\mathrm{dist}}(s_2, y)", xlim=(-8,400), ylim=(-20, 840), legend=:topleft, tickfontsize=6, xguidefontsize=8, yguidefontsize=8, legendfontsize=6, titlefontsize=8, dpi=600)
...
function Figure7()
    ...
    m1_scatter_train = scatter(m1_traindists_s₁_true, m1_traindists_s₂_true, color=:mediumseagreen, alpha=0.5, ms=2, markerstrokewidth=0.1, label="true", xlim=(-0.1,5.8), ylim=(-0.35,10), yticks=0:2:10, xlabel=L"\tilde{\mathrm{dist}}(s_1, y)", ylabel=L"\tilde{\mathrm{dist}}(s_2, y)", legend=:bottomleft, xguidefontsize=8, yguidefontsize=8, legendfontsize=4, xtickfontsize=5, ytickfontsize=5, titlefontsize=8, dpi=600)
...
function Figure8()
    ...
    m2_scatter_test = scatter(m2_testdists_s₁_true, m2_testdists_s₂_true, color=:mediumseagreen, alpha=0.5, ms=2, markerstrokewidth=0.1, label="true", xlim=(2.6,15.1), ylim=(1.2,10), xticks=4:2:14, xlabel=L"\tilde{\mathrm{dist}}(s_1, y)", ylabel=L"\tilde{\mathrm{dist}}(s_2, y)", xguidefontsize=8, yguidefontsize=8, legendfontsize=4, xtickfontsize=5, ytickfontsize=5, titlefontsize=8, legend=:bottomright, dpi=600)
...
function Figure9()
    ...
    IndepB_testscatter = scatter(testdistsB_s₁_system1, testdistsB_s₂_system1, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="system 1", xlabel=L"\tilde{\mathrm{dist}}(s_{B1}, y_B)", ylabel=L"\tilde{\mathrm{dist}}(s_{B2}, y_B)", legend=:topright, tickfontsize=5, xguidefontsize=8, yguidefontsize=8, legendfontsize=4, titlefontsize=8, size=(600,500), dpi=600)
    ...
    IndepC_testscatter = scatter(testdistsC_s₁_system1, testdistsC_s₂_system1, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="system 1", xlabel=L"\tilde{\mathrm{dist}}(s_{C1}, y_C)", ylabel=L"\tilde{\mathrm{dist}}(s_{C2}, y_C)", legend=:topright, tickfontsize=5, xguidefontsize=8, yguidefontsize=8, legendfontsize=4, titlefontsize=8, size=(600,500), dpi=600)
...
function Figure10()
    ...
    scatter_test = scatter(testdistsmulti_s₁_system1, testdistsmulti_s₂_system1, color=:sienna1, alpha=0.5, ms=2, markerstrokewidth=0.1, label="system 1", xlabel=L"\tilde{\mathrm{dist}}(\mathbf{\textit{s}}_1,\mathbf{\textit{y}})", ylabel=L"\tilde{\mathrm{dist}}(\mathbf{\textit{s}}_2,\mathbf{\textit{y}})", legend=:topright, xguidefontsize=8, yguidefontsize=8, legendfontsize=5, tickfontsize=6, titlefontsize=8, dpi=600)
